		...
		******************************************************************************************/
		this.doAssociation = function(){
			...
			if(args[0].toLowerCase()==="qr"){
					...
					}else resolve(JSON.parse('{"response":"<p>Review the number of parameters used.</p>"}'));
							...
							if(args.length==4){
								...
								if(args.length==2){
									...
									/*if(args.length>2){
										...
										}else resolve(JSON.parse('{"response":"<p>The technology has not been developed yet.</p>"}'));
